...
Virtual sound field 支持多种虚拟声道模式，让您可以使用多个耳机/音箱组建自定义的虚拟声场：

### 支持的声道模式

| 模式 | 通道数 | 通道名称 | 用途 |
|------|--------|----------|------|
| **左右分离** | 2 | 左声道、右声道 | 基础立体声分离，适合双人分享音频 |
| **前后立体声** | 2 | 前置立体声、后置立体声 | 创建前后声场，适合沉浸式体验 |
| **四角环绕** | 4 | 前左(FL)、前右(FR)、后左(RL)、后右(RR) | 4声道环绕声场，适合游戏/电影 |
| **5.1声道** | 6 | 前左(FL)、前右(FR)、中置(C)、低音(LFE)、环绕左(SL)、环绕右(SR) | 完整5.1环绕声，专业影音体验 |

### 使用场景

- **游戏体验**：使用四角环绕模式，将4个耳机分别放置在前后左右，获得360度游戏音效
- **家庭影院**：使用5.1声道模式，用多个耳机/音箱组建个人影院系统
